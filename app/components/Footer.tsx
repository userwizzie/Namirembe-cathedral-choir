...
export default function Footer() {
  return <footer className="footer">
    <div className="footer-top">
      ...
      <div className="footer-links"><a href="tel:+256700000000">+256 700 000 000</a><span>Namirembe Hill, Kampala</span><div className="social-links"><a className="social-logo" href="https://namirembecathedral.org" target="_blank" rel="noreferrer" aria-label="Namirembe Cathedral website"><Image src="/Namirembe cathedral logo.png" alt="Cathedral website" width={30} height={34} /></a><a className="social-logo youtube-logo" href="https://www.youtube.com/@NamirembeCathedralChoir" target="_blank" rel="noreferrer" aria-label="YouTube"><Image src="/youtube.svg" alt="YouTube" width={38} height={28} /></a></div></div>
    </div>
    <div className="footer-bottom"><span>© 2026 Namirembe Cathedral Choir</span><span>Serving God through music since 1919</span><Link href="/">Back to top ↑</Link></div>
  </footer>;
}
