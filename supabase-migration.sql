...
create policy "Public can read active services" on services for select to anon, authenticated using (is_active = true);
create policy "Authenticated admins can manage services" on services for all to authenticated using (true) with check (true);
